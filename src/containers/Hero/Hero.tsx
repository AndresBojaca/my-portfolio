        ...
        <div className="mx-auto flex justify-center flex-col gap-10">
          <div className="relative mx-auto">
            <div className="flex justify-center -mb-6">
              ...
              <div className="mt-10 bg-black/[0.05] dark:bg-black/10 rounded-full absolute w-[16rem] h-[16rem] lg:w-[23rem] lg:h-[23rem] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -z-10">
